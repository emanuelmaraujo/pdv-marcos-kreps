...
export function TopBar({ sidebarOpen, onSidebarToggle }: TopBarProps) {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 h-14 border-b border-[var(--border)] bg-[var(--bg-surface)] shadow-[var(--shadow-sm)]">
      <div className="flex h-full items-center justify-between gap-3 px-4 md:px-6">
        <div className="flex min-w-0 items-center gap-3">
          <button
            ...
            className="mr-1 hidden h-9 w-9 items-center justify-center rounded-lg text-[var(--text-secondary)] hover:bg-[var(--bg-subtle)] hover:text-[var(--text-primary)] md:flex lg:hidden"
          >
          ...
          <div className="min-w-0">
            ...
            <p className="hidden truncate text-[11px] font-medium text-[var(--text-secondary)] sm:block">
              {currentBranch ? (
                <span>
                  <span className="text-brand-red font-semibold">{currentBranch.name}</span>
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <button
            onClick={toggleTheme}
            className="flex shrink-0 h-9 w-9 items-center justify-center rounded-lg text-[var(--text-secondary)] hover:bg-[var(--bg-subtle)] hover:text-[var(--text-primary)] active:scale-95"
          ...
          <button
            ...
            className="flex shrink-0 items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-medium text-[var(--text-secondary)] hover:bg-[var(--bg-subtle)] hover:text-[var(--text-primary)] active:scale-95"
            aria-label="Sair"
          >
