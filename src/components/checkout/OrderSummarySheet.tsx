      ...
      <BottomSheet isOpen={isOpen} onClose={handleClose} title="Pedido Finalizado!">
        <div className="flex flex-col items-center justify-center p-6 text-center space-y-4">
          ...
          <p className="text-zinc-600">
            Status: <span className="font-semibold text-orange-600">NA FILA</span>
          </p>
    ...
    <BottomSheet isOpen={isOpen} onClose={handleClose} title="Resumo do Pedido">
      <div className="flex flex-col space-y-6 pb-24">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-white border border-zinc-200 rounded-xl p-4 space-y-3 max-h-[30vh] overflow-y-auto">
            {items.map((item) => (
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-3">
            <input 
              ...
              className="w-full p-3 bg-white border border-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500"
            />
            <input 
              type="tel" 
            ...
            <textarea 
              ...
              className="w-full p-3 bg-white border border-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none h-20"
            />
          </div>
        </div>
            ...
            <div className="bg-white border border-zinc-200 rounded-xl p-4 space-y-3">
              <div className="flex space-x-2">
                <select 
                  ...
                  className="p-3 bg-zinc-50 border border-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500"
                >
                ...
                <input 
                  ...
                  className="flex-1 p-3 bg-white border border-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500"
                />
              </div>
              <input 
                type="text" 
      ...
      {/* Botão Fixo no Rodapé do Bottom Sheet */}
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-zinc-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        <Button 
